...
\adjustbox{valign=t}{\begin{minipage}{0.3\textwidth} % begin column 30% width
    ...
    \includegraphics[width=\linewidth, cfbox=black 1px 0pt]{.{{ project.image.url }}}}
    {% else %}
    \href{% templatetag openbrace %}{{ baseurl|safe }}{{ project_change }}}{%
    \includegraphics[width=\linewidth, , cfbox=black 1px 0pt]{% templatetag openbrace %}%
...
{% include project.progressreport.template_tex with progressreport=project.progressreport sticky=1 %}
{% endif %}
