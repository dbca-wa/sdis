...
\adjustbox{valign=t}{\begin{minipage}{0.3\textwidth} % begin column 30% width
    ...
    \includegraphics[width=\linewidth, frame]{.{{ project.image.url }}}
    {% else %}
    \includegraphics[width=\linewidth, frame]{% templatetag openbrace %}{{ STATIC_ROOT }}/img/intertidal.jpg}
...
\adjustbox{valign=t}{\begin{minipage}[t]{0.65\linewidth}
    ...
    {{ project.student_list_plain|html2latex }}~({{ project.get_level_display|striptags }})\\
