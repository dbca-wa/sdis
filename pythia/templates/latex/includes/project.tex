...
\adjustbox{valign=t}{\begin{minipage}{0.3\textwidth} % begin column 30% width
    ...
    \includegraphics[width=\linewidth]%
        {% templatetag openbrace %}.{{ project.image.url }}}
    {% else %}
    \includegraphics[width=\linewidth]%
        {% templatetag openbrace %}{{ STATIC_ROOT }}/img/intertidal.jpg}
