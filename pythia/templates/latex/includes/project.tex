...
{% with project.title|html2latex as project_title %}
%% Project showcase -----------------------------------------------------------%
\vskip 2em
\noindent
\adjustbox{valign=t}{\begin{minipage}{0.3\textwidth} % begin column 30% width
    ...
    {% else %}
    \href{% templatetag openbrace %}{{ baseurl|safe }}{{ project_change }}}{%
    \includegraphics[width=\linewidth, frame]{% templatetag openbrace %}%
    {{ STATIC_ROOT }}/img/intertidal.jpg}}
    {% endif %}
    \vfill
\end{minipage}}%
\hfill
\adjustbox{valign=t}{\begin{minipage}[t]{0.65\linewidth}
    ...
    \subsection*{% templatetag openbrace %}{{ project_title }}}
    \phantomsection                         % fix pageref from TOC
    \addcontentsline{toc}{subsection}{% templatetag openbrace %}{{ project_title }}}
