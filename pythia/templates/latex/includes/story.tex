...
\vspace{-20pt}
\includegraphics[width=\linewidth]{% templatetag openbrace %}{{ STATIC_ROOT }}/img/storytime.jpg}
\caption*{Applying a satellite transmitter}
\end{wrapfigure}
...
\includegraphics[width=\linewidth]{% templatetag openbrace %}{{ STATIC_ROOT }}/img/sabrina.jpg}
\caption*{Sabrina balancing work, life, and baby Nora.}
\end{wrapfigure}
