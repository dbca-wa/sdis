...
%\fill[color=ParksWildlife!10!white,opacity=.2] (1cm,0) rectangle (
...
\draw[anchor=west] (5cm,-9cm) node [rounded corners=20pt,
  fill=ParksWildlife!10!white,fill opacity=.6,inner sep=12pt,text opacity=1,
  draw=ParksWildlife,draw opacity=1,line width=1.5pt]{
