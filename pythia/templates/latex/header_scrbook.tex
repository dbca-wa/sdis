{% load staticfiles%}
%------------------------------------------------------------------------------%
% header_scrbook.tex Style and layout definitions
%------------------------------------------------------------------------------%
\documentclass[version=last,
    ...
    toc=chapterentrywithoutdots              % Table of Contents style
]{scrbook}
\usepackage{typearea}
...
%\usepackage{tocstyle}          % Deprecated and removed from KOMAscript
\usepackage{tocbasic}
...
% copy-pasted HTML <span> in SPMS fields becomes \text{} in tex source
\providecommand{\text}{}
