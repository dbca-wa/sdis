...
\ihead{\href{% templatetag openbrace %}{{ baseurl|safe }}{{ original_change }}}{%
\textbf{% templatetag openbrace %}{{ subtitle }}}}}
%\chead{\href{% templatetag openbrace %}{{ baseurl|safe }}}{%
Science Directorate Information System}}
\ohead{\href{https://www.dpaw.wa.gov.au/about-us/science-and-research}{%
\includegraphics[height=8mm, keepaspectratio]{% templatetag openbrace %}%
{{ STATIC_ROOT }}/img/logo-dpaw.png}}}
