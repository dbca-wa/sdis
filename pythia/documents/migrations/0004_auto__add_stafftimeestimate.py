...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'StaffTimeEstimate'
        db.create_table(u'documents_stafftimeestimate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'documents_stafftimeestimate_created', to=orm['pythia.User'])),
            ('modifier', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'documents_stafftimeestimate_modified', to=orm['pythia.User'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('document', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['documents.ConceptPlan'])),
            ...
            ('year1', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('year2', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('year3', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'documents', ['StaffTimeEstimate'])


    def backwards(self, orm):
        # Deleting model 'StaffTimeEstimate'
        db.delete_table(u'documents_stafftimeestimate')
