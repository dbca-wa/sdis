...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ConceptPlan.background'
        db.add_column(u'documents_conceptplan', 'background',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ConceptPlan.background'
        db.delete_column(u'documents_conceptplan', 'background')
    ...
    models = {
        ...
        u'projects.project': {
            ...
            'number': ('django.db.models.fields.PositiveIntegerField', [], {'default': '72'}),
