...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ARARReport.sds_intro'
        db.add_column(u'pythia_ararreport', 'sds_intro',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ARARReport.sds_intro'
        db.delete_column(u'pythia_ararreport', 'sds_intro')
