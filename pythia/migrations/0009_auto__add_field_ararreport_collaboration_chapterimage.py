...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ARARReport.collaboration_chapterimage'
        db.add_column(u'pythia_ararreport', 'collaboration_chapterimage',
                      self.gf('django_resized.forms.ResizedImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ARARReport.collaboration_chapterimage'
        db.delete_column(u'pythia_ararreport', 'collaboration_chapterimage')
