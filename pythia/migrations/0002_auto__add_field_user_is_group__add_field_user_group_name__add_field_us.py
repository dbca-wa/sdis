...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'User.is_group'
        db.add_column(u'pythia_user', 'is_group',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'User.group_name'
        db.add_column(u'pythia_user', 'group_name',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'User.affiliation'
        db.add_column(u'pythia_user', 'affiliation',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'User.is_group'
        db.delete_column(u'pythia_user', 'is_group')

        # Deleting field 'User.group_name'
        db.delete_column(u'pythia_user', 'group_name')

        # Deleting field 'User.affiliation'
        db.delete_column(u'pythia_user', 'affiliation')
