...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Division.approver'
        db.add_column(u'pythia_division', 'approver',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'approves_divisions', null=True, to=orm['pythia.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Division.approver'
        db.delete_column(u'pythia_division', 'approver_id')
