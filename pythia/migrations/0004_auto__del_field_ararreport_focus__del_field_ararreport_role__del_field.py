...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'ARARReport.focus'
        db.delete_column(u'pythia_ararreport', 'focus')

        # Deleting field 'ARARReport.role'
        db.delete_column(u'pythia_ararreport', 'role')

        # Deleting field 'ARARReport.vision'
        db.delete_column(u'pythia_ararreport', 'vision')

        # Adding field 'ARARReport.research_intro'
        db.add_column(u'pythia_ararreport', 'research_intro',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ARARReport.student_intro'
        db.add_column(u'pythia_ararreport', 'student_intro',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'ARARReport.focus'
        db.add_column(u'pythia_ararreport', 'focus',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ARARReport.role'
        db.add_column(u'pythia_ararreport', 'role',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'ARARReport.vision'
        db.add_column(u'pythia_ararreport', 'vision',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ARARReport.research_intro'
        db.delete_column(u'pythia_ararreport', 'research_intro')

        # Deleting field 'ARARReport.student_intro'
        db.delete_column(u'pythia_ararreport', 'student_intro')
