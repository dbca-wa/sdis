...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Program.image'
        db.add_column(u'pythia_program', 'image',
                      self.gf(u'django_resized.forms.ResizedImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Program.image'
        db.delete_column(u'pythia_program', 'image')
