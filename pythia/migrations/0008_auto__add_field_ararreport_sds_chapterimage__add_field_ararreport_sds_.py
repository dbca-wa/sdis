...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ARARReport.sds_chapterimage'
        db.add_column(u'pythia_ararreport', 'sds_chapterimage',
                      self.gf('django_resized.forms.ResizedImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ARARReport.sds_orgchart'
        db.add_column(u'pythia_ararreport', 'sds_orgchart',
                      self.gf('django_resized.forms.ResizedImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ARARReport.research_chapterimage'
        db.add_column(u'pythia_ararreport', 'research_chapterimage',
                      self.gf('django_resized.forms.ResizedImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ARARReport.partnerships_chapterimage'
        db.add_column(u'pythia_ararreport', 'partnerships_chapterimage',
                      self.gf('django_resized.forms.ResizedImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ARARReport.studentprojects_chapterimage'
        db.add_column(u'pythia_ararreport', 'studentprojects_chapterimage',
                      self.gf('django_resized.forms.ResizedImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)

        # Adding field 'ARARReport.publications_chapterimage'
        db.add_column(u'pythia_ararreport', 'publications_chapterimage',
                      self.gf('django_resized.forms.ResizedImageField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ARARReport.sds_chapterimage'
        db.delete_column(u'pythia_ararreport', 'sds_chapterimage')

        # Deleting field 'ARARReport.sds_orgchart'
        db.delete_column(u'pythia_ararreport', 'sds_orgchart')

        # Deleting field 'ARARReport.research_chapterimage'
        db.delete_column(u'pythia_ararreport', 'research_chapterimage')

        # Deleting field 'ARARReport.partnerships_chapterimage'
        db.delete_column(u'pythia_ararreport', 'partnerships_chapterimage')

        # Deleting field 'ARARReport.studentprojects_chapterimage'
        db.delete_column(u'pythia_ararreport', 'studentprojects_chapterimage')

        # Deleting field 'ARARReport.publications_chapterimage'
        db.delete_column(u'pythia_ararreport', 'publications_chapterimage')
    ...
    models = {
        ...
        u'pythia.ararreport': {
            ...
            'partnerships_chapterimage': ('django_resized.forms.ResizedImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'pub': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'publications_chapterimage': ('django_resized.forms.ResizedImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'research_chapterimage': ('django_resized.forms.ResizedImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'research_intro': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'sds_chapterimage': ('django_resized.forms.ResizedImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'sds_intro': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'sds_orgchart': ('django_resized.forms.ResizedImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'student_intro': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'studentprojects_chapterimage': ('django_resized.forms.ResizedImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
