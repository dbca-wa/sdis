...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StudentProject.academic_list_plain_no_affiliation'
        db.add_column(u'projects_studentproject', 'academic_list_plain_no_affiliation',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Project.supervising_scientist_list_plain'
        db.add_column(u'projects_project', 'supervising_scientist_list_plain',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StudentProject.academic_list_plain_no_affiliation'
        db.delete_column(u'projects_studentproject', 'academic_list_plain_no_affiliation')

        # Deleting field 'Project.supervising_scientist_list_plain'
        db.delete_column(u'projects_project', 'supervising_scientist_list_plain')
