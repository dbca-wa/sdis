...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'projects_project', 'image', self.gf(u'django_resized.forms.ResizedImageField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'Project.image'
        db.alter_column(u'projects_project', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
    ...
    models = {
        ...
        u'projects.project': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': (u'django_resized.forms.ResizedImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            ...
            'number': ('django.db.models.fields.PositiveIntegerField', [], {'default': '2'}),
