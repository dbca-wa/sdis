...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StudentProject.academic_list_plain'
        db.add_column(u'projects_studentproject', 'academic_list_plain',
    ...
    def backwards(self, orm):
        # Deleting field 'StudentProject.academic_list_plain'
        db.delete_column(u'projects_studentproject', 'academic_list_plain')
