...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ResearchFunction'
        db.create_table(u'projects_researchfunction', (
            ...
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'projects_researchfunction_created', to=orm['pythia.User'])),
            ('modifier', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'projects_researchfunction_modified', to=orm['pythia.User'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('polymorphic_ctype', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'polymorphic_projects.researchfunction_set', null=True, to=orm['contenttypes.ContentType'])),
            ('name', self.gf('pythia.fields.Html2TextField')()),
            ('description', self.gf('pythia.fields.Html2TextField')()),
            ('leader', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'pythia_researchfunction_leader', to=orm['pythia.User'])),
        ))
        db.send_create_signal(u'projects', ['ResearchFunction'])

        # Adding field 'Project.research_function'
        db.add_column(u'projects_project', 'research_function',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.ResearchFunction'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ResearchFunction'
        db.delete_table(u'projects_researchfunction')

        # Deleting field 'Project.research_function'
        db.delete_column(u'projects_project', 'research_function_id')
    ...
    models = {
        ...
        u'projects.project': {
            ...
            'number': ('django.db.models.fields.PositiveIntegerField', [], {'default': '3'}),
        ...
        u'projects.researchfunction': {
            ...
            'description': ('pythia.fields.Html2TextField', [], {}),
            'effective_from': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'effective_to': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'leader': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'pythia_researchfunction_leader'", 'to': u"orm['pythia.User']"}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            ...
            'name': ('pythia.fields.Html2TextField', [], {}),
