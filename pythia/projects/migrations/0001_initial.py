    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creator', models.ForeignKey(related_name='projects_researchfunction_created', editable=False, to=settings.AUTH_USER_MODEL)),
                ...
                ('modifier', models.ForeignKey(related_name='projects_researchfunction_modified', editable=False, to=settings.AUTH_USER_MODEL)),
