...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'projects_project', (
            ...
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'projects_project_created', to=orm['pythia.User'])),
            ('modifier', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'projects_project_modified', to=orm['pythia.User'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, blank=True)),
            ('polymorphic_ctype', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'polymorphic_projects.project_set', null=True, to=orm['contenttypes.ContentType'])),
            ('type', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0)),
            ('status', self.gf('django_fsm.FSMField')(default=u'new', max_length=50)),
            ('year', self.gf('django.db.models.fields.PositiveIntegerField')(default=2014)),
            ('number', self.gf('django.db.models.fields.PositiveIntegerField')(default=8)),
            ('position', self.gf('django.db.models.fields.IntegerField')(default=1000, null=True, blank=True)),
            ('title', self.gf('pythia.fields.Html2TextField')()),
            ('image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('tagline', self.gf('pythia.fields.Html2TextField')(null=True, blank=True)),
            ('comments', self.gf('pythia.fields.Html2TextField')(null=True, blank=True)),
            ...
            ('output_program', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pythia.Division'], null=True, blank=True)),
            ('project_owner', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'pythia_project_owner', to=orm['pythia.User'])),
            ('data_custodian', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'pythia_project_data_custodian', null=True, to=orm['pythia.User'])),
            ('site_custodian', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'pythia_project_site_custodian', null=True, to=orm['pythia.User'])),
            ('team_list_plain', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('area_list_dpaw_region', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('area_list_dpaw_district', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('area_list_ibra_imcra_region', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('area_list_nrm_region', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'projects', ['Project'])

        # Adding unique constraint on 'Project', fields ['year', 'number']
        db.create_unique(u'projects_project', ['year', 'number'])

        # Adding M2M table for field areas on 'Project'
        m2m_table_name = db.shorten_name(u'projects_project_areas')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project', models.ForeignKey(orm[u'projects.project'], null=False)),
            ('area', models.ForeignKey(orm[u'pythia.area'], null=False))
        ))
        db.create_unique(m2m_table_name, ['project_id', 'area_id'])

        # Adding M2M table for field web_resources on 'Project'
        m2m_table_name = db.shorten_name(u'projects_project_web_resources')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('project', models.ForeignKey(orm[u'projects.project'], null=False)),
            ('webresource', models.ForeignKey(orm[u'pythia.webresource'], null=False))
        ))
        db.create_unique(m2m_table_name, ['project_id', 'webresource_id'])

        # Adding model 'ScienceProject'
        db.create_table(u'projects_scienceproject', (
            (u'project_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['projects.Project'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'projects', ['ScienceProject'])

        # Adding model 'CoreFunctionProject'
        db.create_table(u'projects_corefunctionproject', (
            (u'project_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['projects.Project'], unique=True, primary_key=True)),
        ))
        db.send_create_signal(u'projects', ['CoreFunctionProject'])

        # Adding model 'CollaborationProject'
        db.create_table(u'projects_collaborationproject', (
            (u'project_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['projects.Project'], unique=True, primary_key=True)),
            ('name', self.gf('pythia.fields.Html2TextField')(max_length=2000)),
            ('budget', self.gf('pythia.fields.Html2TextField')()),
            ('staff_list_plain', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'projects', ['CollaborationProject'])

        # Adding model 'StudentProject'
        db.create_table(u'projects_studentproject', (
            (u'project_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['projects.Project'], unique=True, primary_key=True)),
            ('level', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=0, null=True, blank=True)),
            ('organisation', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('student_list_plain', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'projects', ['StudentProject'])

        # Adding model 'ProjectMembership'
        db.create_table(u'projects_projectmembership', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('project', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['projects.Project'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['pythia.User'])),
            ('role', self.gf('django.db.models.fields.PositiveSmallIntegerField')()),
            ('time_allocation', self.gf('django.db.models.fields.FloatField')(default=0, null=True, blank=True)),
            ('position', self.gf('django.db.models.fields.IntegerField')(default=100, null=True, blank=True)),
            ('comments', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'projects', ['ProjectMembership'])


    def backwards(self, orm):
        # Removing unique constraint on 'Project', fields ['year', 'number']
        db.delete_unique(u'projects_project', ['year', 'number'])

        # Deleting model 'Project'
        db.delete_table(u'projects_project')

        # Removing M2M table for field areas on 'Project'
        db.delete_table(db.shorten_name(u'projects_project_areas'))

        # Removing M2M table for field web_resources on 'Project'
        db.delete_table(db.shorten_name(u'projects_project_web_resources'))

        # Deleting model 'ScienceProject'
        db.delete_table(u'projects_scienceproject')

        # Deleting model 'CoreFunctionProject'
        db.delete_table(u'projects_corefunctionproject')

        # Deleting model 'CollaborationProject'
        db.delete_table(u'projects_collaborationproject')

        # Deleting model 'StudentProject'
        db.delete_table(u'projects_studentproject')

        # Deleting model 'ProjectMembership'
        db.delete_table(u'projects_projectmembership')
