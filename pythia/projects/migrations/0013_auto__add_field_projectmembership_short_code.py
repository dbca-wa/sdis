...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ProjectMembership.short_code'
        db.add_column(u'projects_projectmembership', 'short_code',
                      self.gf('django.db.models.fields.CharField')(max_length=500, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ProjectMembership.short_code'
        db.delete_column(u'projects_projectmembership', 'short_code')
    ...
    models = {
        ...
        u'projects.project': {
            ...
            'year': ('django.db.models.fields.PositiveIntegerField', [], {'default': '2018'})
        },
