...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResearchFunction.active'
        db.add_column(u'projects_researchfunction', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ResearchFunction.active'
        db.delete_column(u'projects_researchfunction', 'active')
