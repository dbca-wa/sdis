...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ResearchFunction.association'
        db.add_column(u'projects_researchfunction', 'association',
                      self.gf('pythia.fields.Html2TextField')(null=True, blank=True),
                      keep_default=False)
        ...
        db.alter_column(u'projects_researchfunction', 'leader_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['pythia.User']))

    def backwards(self, orm):
        # Deleting field 'ResearchFunction.association'
        db.delete_column(u'projects_researchfunction', 'association')
    ...
    models = {
        ...
        u'projects.researchfunction': {
            ...
            'association': ('pythia.fields.Html2TextField', [], {'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "u'projects_researchfunction_created'", 'to': u"orm['pythia.User']"}),
            'description': ('pythia.fields.Html2TextField', [], {'null': 'True', 'blank': 'True'}),
            'effective_from': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
            'effective_to': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
