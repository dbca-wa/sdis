...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CollaborationProject.aims'
        db.add_column(u'projects_collaborationproject', 'aims',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'CollaborationProject.description'
        db.add_column(u'projects_collaborationproject', 'description',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CollaborationProject.aims'
        db.delete_column(u'projects_collaborationproject', 'aims')

        # Deleting field 'CollaborationProject.description'
        db.delete_column(u'projects_collaborationproject', 'description')
    ...
    models = {
        ...
        u'projects.project': {
            ...
            'year': ('django.db.models.fields.PositiveIntegerField', [], {'default': '2017'})
        },
